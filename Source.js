...
const SubscriptionService = {
	async generateText(user, host) {
		...
		const m1 = decodeURIComponent("%E2%9A%A0%EF%B8%8F%D9%BE%D9%86%D9%84%20%D8%B1%D8%A7%DB%8C%DA%AF%D8%A7%D9%80%D9%86%20%D9%88%20%D8%BA%DB%8C%D8%B0%20%D9%82%D8%A7%D8%A8%D9%84%20%D9%81%D8%B1%D9%88%D8%B4%E2%9A%A0%EF%B8%8F") + (_SECURITY_CORE ? "" : "_ERR");
...
<style>
	...
	#cursor-glow-visual {
		...
		height: 100%;
		border-radius: 50%;
		background: radial-gradient(circle, rgba(37, 99, 235, 0.6) 0%, rgba(29, 78, 216, 0.25) 50%, transparent 80%);
		filter: blur(4px);
	}
</style>
<script>
	document.addEventListener('DOMContentLoaded', () => {
		if (window.matchMedia('(pointer: fine)').matches) {
			...
			function animatePhysics() {
				...
				ringPos.style.top = ringY + 'px';
				ringPos.style.left = ringX + 'px';

				glowX += (mouseX - glowX) * 0.12;
				glowY += (mouseY - glowY) * 0.12;
				glowPos.style.top = glowY + 'px';
				glowPos.style.left = glowX + 'px';
